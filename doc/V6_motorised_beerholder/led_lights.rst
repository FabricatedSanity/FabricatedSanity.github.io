...
This page will go though the LED lights we have used in the engine block, how we have connected them and how they are controlled.
...
We used an addressable RGB LED strips, which are connected to the ESP32 microcontroller.
The LED strip where cut into 10 single LEDs to get the correct placement of the LEDs in the holes of the engine block.
Each singe LED where soldered on its in side and tested to make sure they worked before connecting them further.
Began with the first LED in the system, placed it inside the motor to find out how long the wires needed to be to easily connenct to the next LED, without beeing to long to colide with the moving parts of the motor.
